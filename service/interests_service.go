...
type InterestsService interface {
	GetInterests(ctx context.Context) ([]db.Interest, *golaerror.Error)
}
...
func (service interestsService) GetInterests(ctx context.Context) ([]db.Interest, *golaerror.Error) {
