...
require (
	...
	github.com/gola-glitch/gola-utils v0.0.0-20220126121802-e985d4a748fb
...
require (
	contrib.go.opencensus.io/exporter/ocagent v0.7.1-0.20200812142813-b599b1f9e024 // indirect
