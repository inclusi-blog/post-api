...
func (repository postRepository) FetchPost(ctx context.Context, postId, userId uuid.UUID) (response.Post, error) {
	...
	err := repository.db.GetContext(ctx, &post, GetPost, postId, userId, postId)
